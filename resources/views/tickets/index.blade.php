    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <a href="{{ url('user/ticket/create') }}" class="btn btn-primary btn-md waves-effect">Tambah Baru</a>
            </div>
            <!-- Basic Table -->
                            ...
                            <table id="locations-table" class="table table-bordered table-striped responsive">
                                ...
                                @foreach($tickets as $data)
                                    <tr>
                                        ...
                                        <td>    
                                            <a href="{{ url('user/ticket/edit', $data->ticket_id) }}" class="btn btn-sm btn-success"><i class="material-icons">mode_edit</i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                @endforeach

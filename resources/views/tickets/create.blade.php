            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form role="form" method="post" action="{{ url('user/ticket/add_new') }}">
                                {{ csrf_field() }}
                                <label for="ticket_name">Nama Tiket</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="ticket_name" name="ticket_name" class="form-control" placeholder="Masukkan Nama Acara">
                                    </div>
                                </div>
                                <label for="ticket_price">Harga Tiket</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="ticket_price" name="ticket_price" class="form-control" placeholder="Masukkan Deskripsi Acara">
                                    </div>
                                </div>

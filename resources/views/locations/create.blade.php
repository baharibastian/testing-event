            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form role="form" method="post" action="{{ url('user/location/add_new') }}">
                                {{ csrf_field() }}
                                <label for="location_name">Nama Lokasi</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="location_name" name="location_name" class="form-control" placeholder="Masukkan Nama Acara">
                                    </div>
                                </div>
                                <label for="location_address">Alamat Lokasi</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="location_address" name="location_address" class="form-control" placeholder="Masukkan Deskripsi Acara">
                                    </div>
                                </div>

    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('url') }}">EVENT MANAGEMENT SYSTEM</a>
            </div>
        </div>
    </nav>
    <section>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form role="form" method="post" action="{{ url('user/location/update', $location->location_id) }}">
                                {{ csrf_field() }}
                                <label for="location_name">Nama Lokasi</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="location_name" name="location_name" value="{{ $location->location_name }}" class="form-control" placeholder="Masukkan Nama Acara">
                                    </div>
                                </div>
                                <label for="location_address">Alamat Lokasi</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="location_address" name="location_address" value="{{ $location->location_address }}" class="form-control" placeholder="Masukkan Deskripsi Acara">
                                    </div>
                                </div>
                                <label for="location_city">Kota Lokasi</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="location_city" name="location_city" value="{{ $location->location_city }}" class="form-control">
                                    </div>
                                </div>

    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <a href="{{ url('user/location/create') }}" class="btn btn-primary btn-md waves-effect">Tambah Baru</a>
            </div>
            <!-- Basic Table -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <table id="locations-table" class="table table-bordered table-striped responsive">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Nama Lokasi</th>
                                ...
                                @foreach($locations as $data)
                                    <tr>
                                        ...
                                        <td>    
                                            <a href="{{ url('user/location/edit', $data->location_id) }}" class="btn btn-sm btn-success"><i class="material-icons">mode_edit</i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                @endforeach

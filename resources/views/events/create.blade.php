            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form role="form" method="post" action="{{ url('user/event/add_new') }}">
                                {{ csrf_field() }}
                                <label for="event_name">Nama Acara</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="event_name" name="event_name" class="form-control" placeholder="Masukkan Nama Acara">
                                    </div>
                                </div>
                                <label for="event_desc">Deskripsi Acara</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="event_desc" name="event_desc" class="form-control" placeholder="Masukkan Deskripsi Acara">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select class="form-control" id="event_location" name="location_id">
